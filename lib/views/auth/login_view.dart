...
class _LoginScreen1WidgetState extends State<LoginScreen1Widget> {
  ...
  void _onSignIn() {
    ...
    Navigator.pushNamed(context, '/'); // Naviga alla home, ad esempio
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          // ----------------------------------
          // Immagine in alto (sfondo / illustrazione)
          // ----------------------------------
          Positioned(
            top: -3,
            left: -4,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Per evitare che il contenuto si “nasconda”
